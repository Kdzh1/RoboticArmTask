...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 22, 2021 at 12:55 AM
...
CREATE TABLE IF NOT EXISTS `arm` (
  ...
  `condition` varchar(3) NOT NULL DEFAULT 'off'
...
INSERT INTO `arm` (`motor1`, `motor2`, `motor3`, `motor4`, `motor5`, `motor6`, `condition`) VALUES
